...
1) Ingresar una lista [] de productos y que a partir de esta determine a través de una nueva lista [] aquellos productos para los cuales no hay suficiente stock para cubrir todas las órdenes que haya con pedidos de dicho producto.
