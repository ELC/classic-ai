...
![Figura 5.1: neurona biológica](images/figura-5-1-neurona-biológica.png)
...
a lo largo del axón hacia las neuronas con las cuales sinapsis.
...
![Función lineal de base: sumatoria ponderada](images/función-lineal-base-sumatoria-ponderada.png)
...
![Función radial de base: distancia al patrón](images/función-radial-base-distancia-patrón.png)
...
![Función de activación lineal](images/función-activación-lineal.png)
...
![Función de activación de escalón unitario](images/función-activación-escalón-unitario.png)
...
![Formula de la función sigmoidal logística](images/formula-función-sigmoidal-logística.png)
...
![Gráfica de la función sigmoidal logística](images/grafica-función-sigmoidal-logística.png)
...
![Tabla comparativa entre redes biológicas y artificiales](images/tabla-comparación-redes-biológicas-artificiales.png)
...
3. **Operación en tiempo real:** las cómputos neuronales pueden ser realizados
 en
...
*Mientras que el aprendizaje* es *la modificación de cada e/elemento procesal, la
...
![Figura 5.7: modelo de perceptron con cajas lógicas](images/figura-5-7-modelo-perceptron-cajas-lógicas.png)
...
el procedimiento es increíblemente directo. Básicamente, se empieza con todos
los pesos en 0. Después se intenta el perceptrón con todas las muestras, una a
...
2. Durante el segundo paso, la primera muestra produce un 1, pero debería
...
![Figura 5.10: separación lineal de OR](images/figura-5-10-separación-lineal-or.png)
...
específica de el. La red encuentra automáticamente el emparejamiento más próximo.
...
***La mayor contribución de las redes de Hopfield/d* es *la de mostrar que dado un
...
![Figura 5.14: paisaje de búsqueda de estados](images/figura-5-14-paisaje-búsqueda-estados.png)
...
cuando no debe. Esto no representaría mayor problema, ya que las unidades
...
![Formula de probabilidad de activación en Boltzmann](images/formula-probabilidad-activación-boltzmann.png)
