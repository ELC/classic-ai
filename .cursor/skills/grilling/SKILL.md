...
When a question concerns product behavior, phrase it from the user's
perspective. Drive toward one happy path, user-visible edge cases, BDD-ready
Given/When/Then outlines, and a readable sequence diagram boundary.
